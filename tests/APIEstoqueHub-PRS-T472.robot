...
...    
...        {
...            "idSku": 1000000827,    #sku de kit fornecedor
...            "quantidade": 1
...        },
...    
...        {
...
*** Test Cases ***
Validar o retorno da chamada na api vv-estoque-hub quando parametrizado SKU kit Fornecedor com SKU de Kit Comercial na mesma chamada
    
    [tags]      cats-regionalizcao    estoque-hub   task-1871    prs-t472
    ...
    ${response}=  POST On Session  mysession  /v1/simulacao   data=${body_hubPRS-T472}   headers=${header}    expected_status=200
