...
*** Test Cases ***
Validar Retorno da Api para 2 Skus com quantidades zero
    
    [tags]      cats-regionalizcao    estoque-hub    task-1860    endpoint-simulacaodetalhada    prs-t444
    ...
    ${response}=  POST On Session  mysession  /v1/simulacaodetalhada   data=${body_hubPRS-T444}   headers=${header}    expected_status=422
