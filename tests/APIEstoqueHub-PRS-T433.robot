...
Validar Retorno da Api para Sku invalido
    ...
    [tags]      cats-regionalizcao    estoque-hub    task-1860    prs-t433        
    ...
    ${response}=  POST On Session  mysession  /v1/simulacao   data=${body_hubT433}   headers=${header}    expected_status=400
