...
Validar Retorno da Api para 1 Sku inválido com quantidade válida

    [tags]      cats-regionalizcao    estoque-hub    task-1860    endpoint-simulacaodetalhada    prs-t442        
    ...
    ${response}=  POST On Session  mysession  /v1/simulacaodetalhada   data=${body_hubT442}   headers=${header}    expected_status=400
