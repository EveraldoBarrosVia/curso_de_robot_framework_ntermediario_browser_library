...
Validar Retorno da Api para Sku com quantidade inválida
    ...
    [tags]      cats-regionalizcao    estoque-hub    task-1860    endpoint-simulacaodetalhada    prs-t441        
    ...
    ${response}=  POST On Session  mysession  /v1/simulacaodetalhada   data=${body_hubT441}   headers=${header}    expected_status=400
