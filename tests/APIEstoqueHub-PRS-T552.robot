...
*** Test Cases ***
Validar o retorno da chamada na api vv-estoque-hub simulacaoDetalhada parametrizando sku avulso

    [Tags]      cats-regionalizcao    estoque-hub    task-1869    prs-t552
    ...
    ${response}=  POST On Session  mysession  /v1/simulacaodetalhada   data=${body_hubPRS-T552}   headers=${header}    expected_status=200
