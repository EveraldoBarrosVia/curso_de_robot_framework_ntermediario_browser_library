...
*** Test Cases ***
Validar o retorno da chamada na api vv-estoque-hub quando parametrizado SKU filho com SKU avulso na mesma chamada
    
    [tags]      cats-regionalizcao    estoque-hub    task-1871    prs-t470
    ...
    ${response}=  POST On Session  mysession  /v1/simulacao   data=${body_hubPRS-T470}   headers=${header}    expected_status=200
