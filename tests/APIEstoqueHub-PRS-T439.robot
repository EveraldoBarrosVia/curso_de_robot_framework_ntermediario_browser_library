...
Validar Retorno da Api para 2 Skus com quantidades válidas

    [tags]      cats-regionalizcao    estoque-hub    task-1860    endpoint-simulacaodetalhada    prs-t439       
    ...
    ${response}=  POST On Session  mysession  /v1/simulacaodetalhada   data=${body_hubT439}   headers=${header}    expected_status=200
