...
Validar a mensagem com quantidade zero para dois SKUS
    ...
    [tags]      cats-regionalizcao    estoque-hub    task-1853    prs-t412
    ...
    ${response}=  POST On Session  mysession  /v1/simulacao   data=${body_hubPRS-T412}   headers=${header}    expected_status=422
