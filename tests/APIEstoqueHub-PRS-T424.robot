...
Validar o retorno da api estoque hub para sku duplicado
    ...
    [tags]      cats-regionalizcao    estoque-hub    task-1860    endpoint-simulacao    prs-t424        
    ...
    ${response}=  POST On Session  mysession  /v1/simulacao   data=${body_hubT424}   headers=${header}    expected_status=422
