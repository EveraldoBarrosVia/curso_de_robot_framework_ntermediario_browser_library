...
*** Test Cases ***
Validar o retorno da chamada na api vv-estoque-hub simulacaoDetalhada parametrizando sku inválido

    [Tags]      cats-regionalizcao    estoque-hub    task-1869    prs-t554
    ...
    ${response}=  POST On Session  mysession  /v1/simulacaodetalhada   data=${body_hubPRS-T554}   headers=${header}    expected_status=400
