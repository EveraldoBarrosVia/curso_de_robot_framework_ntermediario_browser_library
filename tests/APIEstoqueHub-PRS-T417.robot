...
*** Test Cases ***
Validar a mensagem de retorno para SKUS duplicados

    [tags]      cats-regionalizcao    estoque-hub   task-1853    prs-t417  
    ...
    ${response}=  POST On Session  mysession  /v1/simulacao   data=${body_hubT417}   headers=${header}    expected_status=422
