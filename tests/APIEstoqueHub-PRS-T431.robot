...
Validar a mensagem com quantidade negativa
    ...
    [tags]      cats-regionalizcao    estoque-hub   task-1860    prs-t431  
    ...
    ${response}=  POST On Session  mysession  /v1/simulacao   data=${body_hubT431}   headers=${header}    expected_status=422
