...
*** Test Cases ***
Validar o retorno da chamada na api vv-estoque-hub parametrizando sku avulso kit comercial e kit fornecedor na mesma chamada

    [Tags]      cats-regionalizcao    estoque-hub    task-1869    prs-t553
    ...
    ${response}=  POST On Session  mysession  /v1/simulacaodetalhada   data=${body_hubPRS-T553}   headers=${header}    expected_status=200
