...
Validar o retorno da chamada na api vv-estoque-hub quando parametrizado skus kit e avulso na mesma chamada 
    ...
    [tags]      cats-regionalizcao    estoque-hub    task-1860    endpoint-simulacaodetalhada    prs-t451    
    ...
    ${response}=  POST On Session  mysession  /v1/simulacaodetalhada   data=${body_hubPRS-T451}   headers=${header}    expected_status=200
