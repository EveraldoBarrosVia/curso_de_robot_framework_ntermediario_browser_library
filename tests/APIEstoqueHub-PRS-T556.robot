...
...          "itens": [
...            {
...          "idSku": 1000000827,    #kit fornecedor
...          "quantidade": 1
...     }
...         ]
...            }
...
*** Test Cases ***
Validar o retorno da chamada na api vv-estoque-hub simulacaoDetalhada parametrizando sku kit fornecedor

    [Tags]      cats-regionalizcao    estoque-hub    task-1869    prs-t556
    ...
    ${response}=  POST On Session  mysession  /v1/simulacaodetalhada   data=${body_hubPRS-T556}   headers=${header}    expected_status=200
