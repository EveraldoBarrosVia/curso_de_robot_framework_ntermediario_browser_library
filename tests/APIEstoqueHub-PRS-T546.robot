...
*** Test Cases ***
Validar o retorno da chamada na api vv-estoque-hub parametrizando sku kit comercial 
    [Tags]      cats-regionalizcao    estoque-hub    task-1869    prs-t546
    ...
    ${response}=  POST On Session  mysession  /v1/simulacao   data=${body_hubPRS-T546}   headers=${header}    expected_status=200
