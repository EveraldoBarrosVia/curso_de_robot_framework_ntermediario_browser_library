...
Validar Retorno da Api para 1 Sku com quantidade zero
    
    [tags]      cats-regionalizcao    estoque-hub    task-1860    endpoint-simulacaodetalhada    prs-t440
    ...
    ${response}=  POST On Session  mysession  /v1/simulacaodetalhada   data=${body_hubPRS-T440}   headers=${header}    expected_status=422
