...
*** Test Cases ***
Validar o retorno da chamada na api vv-estoque-hub quando parametrizado SKU Kit Fornecedor
    
    [tags]      cats-regionalizcao    estoque-hub    task-1871    prs-t474
    ...
    ${response}=  POST On Session  mysession  /v1/simulacao   data=${body_hubPRS-T474}   headers=${header}    expected_status=200
