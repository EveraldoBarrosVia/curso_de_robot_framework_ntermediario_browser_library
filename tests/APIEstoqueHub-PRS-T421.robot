...
Validar Retorno da Api para 2 Skus com quantidades válidas
    ...
    [tags]      cats-regionalizcao    estoque-hub   task-1860    endpoint-simulacao    prs-t421  
    ...
    ${response}=  POST On Session  mysession  /v1/simulacao   data=${body_hubT421}   headers=${header}    expected_status=200
