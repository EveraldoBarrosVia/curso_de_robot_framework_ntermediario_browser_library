...
*** Test Cases ***
Validar o retorno da chamada na api vv-estoque-hub parametrizando sku avulso
    [Tags]      cats-regionalizcao    estoque-hub    task-1869    prs-t545
    ...
    ${response}=  POST On Session  mysession  /v1/simulacao   data=${body_hubPRS-T545}   headers=${header}    expected_status=200
